...
const SentSlideCard = ({ slideSentPosts, userInfo }) => {
          ...
          <Col sm={10} md={10} lg={10} className="mt-3 mb-3">
            ...
            >
              ...
              <BackSide className="d-flex align-items-center">
                <Image
                  src={IMAGE_URL + "/" + post.poContentPhoto}
                  width="100%"
                  height="100%"
                />
              </BackSide>
