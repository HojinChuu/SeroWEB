    ...
    <Container>
      <div className="row justify-content-center" style={distanceStyle}>
        <Card style={titleStyle}>
          <Image src="/image/socialTitle.png" />
        </Card>
      </div>
      <div className="row justify-content-center" style={distanceStyle}>
      ...
      <div className="row pt-5 justify-content-center" style={distanceStyle}>
        <Card id="socialCardImage" style={{ width: "80%" }}>
          ...
          />
          <Card.Body id="socialLastCard">
            <Card.Text>
              힘들어하고 있는 소중한 사람들에게 엄지 챌린지와 함께 안부를
              전해주세요. 조금은 어이없을 수도, 또 조금은 하찮을 수도 <br></br>
              있지만 아무렴 어때요. 지친 일상 속 사소한 웃음으로 오늘 하루를
              견딜 수 있는 힘이 될 거예요.
            </Card.Text>
            <p>
